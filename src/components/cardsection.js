...
const cardsection = () => {
    return (
        <div>
        <div className=" container m-auto flex items-center w-full px-4 py-10 bg-cover card bg-base-200" style={{backgroundImage: 'url("https://picsum.photos/id/314/1000/300")'}}>
  <div className="card glass lg:card-side text-neutral-content">
    ...
    <div className="container  m-auto py-8 flex items-center space-x-8">  
    <div className="bg-gradient-to-b from-purple-700 w-full md:w-30 to-gray-600 w-full rounded-lg p-4 mb-6 shadow sm:inline-block">
  <div className="flex items-start text-left">
    <div className="flex-shrink-0">
      <div className="inline-block relative">
        <a href="#" className="block relative">
          <img alt="profil" src="https://www.tailwind-kit.com/images/person/4.jpg" className="mx-auto object-cover rounded-full h-16 w-16 " />
        </a>
      </div>
    </div>
    <div className="ml-6">
